...
| **kestrel-core** | EventBus 多分区，Alert，Action，Time/Replay | ✅ 稳定 |
...
| **kestrel-ebpf** | eBPF 采集层，RingBuf polling，LSM hooks | 🚧 Phase 6 |
...
- **Phase 0-5**: ✅ 基础架构完成
- **Phase 6**: 🚧 实时阻断进行中 (v0.9) - Action系统+LSM hooks已完成
- **Phase 7**: ✅ 离线可复现完成
- **测试覆盖**: ✅ 126/126 测试通过
